...
try {
    ...
    Image plane1(Point(200,0),"image.jpg");
    //plane1.set_mask(Point(200,0),200,200);
    win.attach(plane1);
    Image plane2(Point(500,200),"image.jpg");
    //plane2.set_mask(Point(200,0),200,200);
    win.attach(plane2);
    Image plane3(Point(100,500),"image.jpg");
    ...
    Image smallplane(Point(0,0),"image2.jpg");
    //smallplane.set_mask(Point(110,70),100,100);
    win.attach(smallplane);
    //win.resize(1000,800);
    win.wait_for_button();
    ...
    while (true) {
        x = randint(8);
        y = randint(8);
        dx = 100*x - smallplane.point(0).x;
        dy = 100*y - smallplane.point(0).y;
        smallplane.move(dx,dy);
        //win.resize(1000,800);
        win.wait_for_button();
    }
}
